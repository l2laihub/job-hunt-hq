...
export function profileRowToUserProfileWithMeta(row: ProfileRow): UserProfileWithMeta {
  ...
  const profile: UserProfileWithMeta = {
    ...
    otherLinks: (row.other_links as unknown as { label: string; url: string }[]) || [],
    ...
    skillGroups: (row.skill_groups as unknown as UserProfile['skillGroups']) || [],
...
export function applicationRowToJobApplication(row: ApplicationRow): JobApplication {
  return {
    ...
    compMin: row.comp_min ?? undefined,
    compMax: row.comp_max ?? undefined,
    compUnit: row.comp_unit || undefined,
    compCurrency: row.comp_currency || undefined,
...
export function jobApplicationToRow(
  ...
  return {
    ...
    recruiter_contact: app.recruiterContact || null,
    contacted_date: app.contactedDate || null,
    next_action: app.nextAction || null,
    next_action_date: app.nextActionDate || null,
    comp_min: app.compMin ?? null,
    comp_max: app.compMax ?? null,
    comp_unit: app.compUnit || null,
    comp_currency: app.compCurrency || null,
  };
}
