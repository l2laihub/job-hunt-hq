...
type TabId = 'overview' | 'media' | 'decisions' | 'challenges' | 'metrics';
...
export const ProjectDocModal: React.FC<ProjectDocModalProps> = ({
  ...
  const tabs: { id: TabId; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'decisions', label: 'Decisions', icon: <Lightbulb className="w-4 h-4" /> },
    { id: 'challenges', label: 'Challenges', icon: <Puzzle className="w-4 h-4" /> },
